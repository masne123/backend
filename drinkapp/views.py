...
from .serializers import CustomerSerializers, OrderSerializers, PaymentSerializers, MotorcycleTypeSerializers
...
manage_MotorcycleType = generic_api(MotorcycleType, MotorcycleTypeSerializers)
